...
<head>
    ...
    <meta property="og:image" content="http://webarts.pro/img/ogp.png" />
    ...
    <link rel="shortcut icon" href="http://webarts.pro/img/favicon.ico">
    <link href="http://webarts.pro/css/style.css" rel="stylesheet" type="text/css">
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
</head>

<body style="background: url(http://webarts.pro/img/bg/order_bg.png);background-repeat: repeat;">
    <header>
        <div class="container">
            <div class="logo">
                <a href="http://webarts.pro/">
                    <img src="http://webarts.pro/img/logo.png" alt="logo" width="152" height="40">
                </a>
            </div>
            ...
            <nav>
                <ul>
                    <li><a href="http://webarts.pro/landing.php">Лендинги</a>
                    </li>
                    <li><a href="http://webarts.pro/promo.php">Промо-сайты</a>
                    </li>
                    <li><a href="http://webarts.pro/vizitka.php">Сайты-визитки</a>
                    </li>
                    <li><a href="http://webarts.pro/corporate.php">Корпоративные</a>
                    </li>
                    <li><a href="http://webarts.pro/shop.php">Интернет-магазины</a>
                    </li>
                    <li><a href="http://webarts.pro/portal.php">Порталы</a>
                    </li>
                </ul>
            </nav>
        </div>
